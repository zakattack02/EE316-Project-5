...
void GpioHandler(void *CallbackRef)
{
	...
	if (data == btn0_value){
		xil_printf("BTN0 Press\r\n");
	}

	else if (data == btn1_value){
		//xil_printf("BTN1 Press\r\n");
...
//		}
		...
		xil_printf("Hmm... I didn't register any button presses\r\n");
	}

	//if channel == 17, change to 25
	//if channel ==25, change to 17
